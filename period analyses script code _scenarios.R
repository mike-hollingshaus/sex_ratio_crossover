...
maxSSR <- 1.086
minSSR <- 1.017
perFits <- lapply(perdat, srAnalyses, type='period', lowerBoundYear=startYear, SSR=minSSR) # Scenario Code
cohFits <- lapply(cohdat, srAnalyses, type='cohort', lowerBoundYear=startYear, SSR=minSSR) # Scenario Code
# perFits <- lapply(perdat, srAnalyses, type='period', lowerBoundYear=startYear, SSR=maxSSR) # Scenario Code
# cohFits <- lapply(cohdat, srAnalyses, type='cohort', lowerBoundYear=maxSSR) # Scenario Code
